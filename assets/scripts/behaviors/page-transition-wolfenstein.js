...
const container = document.getElementById('transitionContainerWolfenstein');
...
const pixelSize = 80; //size of .pixel-wolfenstein in styles.css
...
for (let i = 0; i < pixelCountWidth; i++){
    ...
    for (let j = 0; j < pixelCountHeight; j++) {
        ...
        pixel.classList.add('pixel-wolfenstein');
...
animate('.pixel-wolfenstein', {
    delay: stagger(utils.random(0, 3000)),
    opacity: [1, 0],
    duration: 500,
